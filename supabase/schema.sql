...
-- =====================================================================
--  CLAIM ON-CHAIN : table claims + fonctions atomiques
--  (également disponible seul dans supabase/claim.sql)
-- =====================================================================
...
-- Réserve atomique : verrou + décrément + claim 'pending'.
...
-- Remboursement si le transfert on-chain échoue (idempotent).
